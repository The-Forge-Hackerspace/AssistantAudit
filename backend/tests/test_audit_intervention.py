...
class TestAuditInterventionFields:
    ...
    def test_update_audit_intervention_fields(self, client: TestClient, auditeur_headers, entreprise):
        ...
        resp = client.put(f"/api/v1/audits/{audit_id}", json={
    ...
    def test_existing_audits_unaffected(self, client: TestClient, auditeur_headers, db_session, auditeur_user, entreprise):
