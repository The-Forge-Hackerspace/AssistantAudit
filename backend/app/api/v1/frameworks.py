...
def import_single_framework(
    ...
    try:
        # Le service applique une allowlist regex stricte sur le basename
        # et reconstruit le chemin depuis FRAMEWORKS_DIR (sanitizer reconnu).
        framework = FrameworkService.import_from_yaml_name(db, filename)
        return framework
