...
|-----------|--------|
| Workspace | TOSAGA |
| Team ID | `0ca97b7a-45ce-47ae-aaaf-adc7687f8eb1` |
| Team Key | TOSAGA |
| Prochain numéro Epic | 8 |
| Prochain numéro User Story | US041 |
...
|----|-------|----------|--------|--------|--------|
| US001 | Pipeline CI/CD complète | P0 Urgent | 13 | Todo | [TOS-5](https://linear.app/tosaga/issue/TOS-5/us001-pipeline-cicd-complete) |
...
| US | Titre | Priorité | Points | Statut | Linear |
|----|-------|----------|--------|--------|--------|
| US031 | Modèle Finding & cycle de vie | P0 Urgent | 13 | Todo | [TOS-35](https://linear.app/tosaga/issue/TOS-35/us031-modele-finding-and-cycle-de-vie) |
